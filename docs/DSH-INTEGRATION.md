...
The first integration deliberately exposes only the compact Project Harness state:
...
The next integration slice will add explicit project-state commands and specialist routing, beginning with WordPress.
